...
MCJ_CMP_Z		EQU  2		; メモリー比較結果がZならジャンプ		;///< Jump condition: last compare was equal.
MCJ_CMP_NZ		EQU  3		; メモリー比較結果がNZならジャンプ		;///< Jump condition: last compare was not equal.
MCJ_CMP_C		EQU  4		; メモリー比較結果がCならジャンプ		;///< Jump condition: last compare set carry.
MCJ_CMP_NC		EQU  5		; メモリー比較結果がNCならジャンプ		;///< Jump condition: last compare cleared carry.
MCJ_ENEMY_Z		EQU  10		; 敵の残りがゼロならジャンプ		;///< Jump condition: no enemies left.
MCJ_ENEMY_NZ	EQU  11		; 敵の残りがゼロでないならジャンプ	;///< Jump condition: enemies left.
